...
"[project]/app/student/quizzes/[id]/FlashcardQuiz.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FlashcardQuiz({ quiz, questions }) {
    ...
    const [flippedStates, setFlippedStates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const currentQuestion = questions.questions[currentQuestionIndex];
    const totalQuestions = questions.questions.length;
    // Load saved flipped states from localStorage
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FlashcardQuiz.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FlashcardQuiz.useEffect": ()=>{
            ...
            const timer = setInterval({
                "FlashcardQuiz.useEffect.timer": ()=>{
                    setCurrentTime(new Date());
                }
            }["FlashcardQuiz.useEffect.timer"], 1000);
            ...
            return ({
                "FlashcardQuiz.useEffect": ()=>clearInterval(timer)
            })["FlashcardQuiz.useEffect"];
        }
    }["FlashcardQuiz.useEffect"], []);
    const toggleSidebar = ()=>{
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            currentQuestionIndex === totalQuestions - 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(FlashcardQuiz, "JI5WEaDvWetc2mZ9Ky+XoA2R0h0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = FlashcardQuiz;
var _c;
__turbopack_context__.k.register(_c, "FlashcardQuiz");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/student/quizzes/[id]/MCQQuiz.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MCQQuiz({ quiz, questions }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MCQQuiz.useEffect": ()=>{
            ...
            setCurrentTime(new Date());
            const timer = setInterval({
                "MCQQuiz.useEffect.timer": ()=>{
                    setCurrentTime(new Date());
                }
            }["MCQQuiz.useEffect.timer"], 1000);
            const savedTheme = localStorage.getItem('theme');
            if (savedTheme === 'dark') {
                setDarkMode(true);
                document.documentElement.classList.add('dark-mode');
            ...
            return ({
                "MCQQuiz.useEffect": ()=>clearInterval(timer)
            })["MCQQuiz.useEffect"];
        }
    }["MCQQuiz.useEffect"], []);
    const toggleSidebar = ()=>{
...
_s(MCQQuiz, "omYKuSePShBRSD4EFwdu6AFwEGk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = MCQQuiz;
var _c;
__turbopack_context__.k.register(_c, "MCQQuiz");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/student/quizzes/[id]/FillInQuiz.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FillInQuiz({ quiz, questions }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FillInQuiz.useEffect": ()=>{
            ...
            setCurrentTime(new Date());
            const timer = setInterval({
                "FillInQuiz.useEffect.timer": ()=>{
                    setCurrentTime(new Date());
                }
            }["FillInQuiz.useEffect.timer"], 1000);
            const savedTheme = localStorage.getItem('theme');
            if (savedTheme === 'dark') {
                setDarkMode(true);
                document.documentElement.classList.add('dark-mode');
            ...
            return ({
                "FillInQuiz.useEffect": ()=>clearInterval(timer)
            })["FillInQuiz.useEffect"];
        }
    }["FillInQuiz.useEffect"], []);
    const toggleSidebar = ()=>{
...
_s(FillInQuiz, "PEMMgam+UyeCcZbrk9AcBBhZacY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = FillInQuiz;
var _c;
__turbopack_context__.k.register(_c, "FillInQuiz");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/student/quizzes/[id]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$dashboard$2f$mockData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/student/dashboard/mockData.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$quizzes$2f5b$id$5d2f$FlashcardQuiz$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/student/quizzes/[id]/FlashcardQuiz.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$quizzes$2f5b$id$5d2f$MCQQuiz$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/student/quizzes/[id]/MCQQuiz.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$quizzes$2f5b$id$5d2f$FillInQuiz$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/student/quizzes/[id]/FillInQuiz.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function QuizPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuizPage.useEffect": ()=>{
            ...
            const quizData = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$dashboard$2f$mockData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCompletedQuizzes"].find({
                "QuizPage.useEffect.quizData": (q)=>q.id === quizId
            }["QuizPage.useEffect.quizData"]);
            const quizQuestions = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$dashboard$2f$mockData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockQuizQuestions"][quizId];
    ...
    switch(quiz.quizType){
        case "Flashcard":
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$quizzes$2f5b$id$5d2f$FlashcardQuiz$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                quiz: quiz,
                questions: questions
            }, void 0, false, {
                fileName: "[project]/app/student/quizzes/[id]/page.jsx",
        ...
        case "MCQ":
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$quizzes$2f5b$id$5d2f$MCQQuiz$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                quiz: quiz,
                questions: questions
            }, void 0, false, {
                fileName: "[project]/app/student/quizzes/[id]/page.jsx",
        ...
        case "Fill-in":
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$student$2f$quizzes$2f5b$id$5d2f$FillInQuiz$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                quiz: quiz,
                questions: questions
            }, void 0, false, {
                fileName: "[project]/app/student/quizzes/[id]/page.jsx",
...
_s(QuizPage, "5FfmA34xUOhezd+phnnh+btEcXo=", false, function() {
    return [
...
//# sourceMappingURL=app_student_292c6d85._.js.map