...
import {FaChalkboardTeacher, FaBook, FaUsers, FaCalendarAlt, FaCog, FaMicrophone, FaChartLine} from "react-icons/fa";
...
export default function EducatorDashboard() {
    ...
    return (
        <div className={`${rootBgClass} flex min-h-screen`}>
            ...
            >
                <div>
                    <div className="flex items-center justify-between">
                        <h2 className={`text-2xl font-bold ${sidebarText}`}>
                            fLexiScribe
                        </h2>
                        <button
                    ...
                    <ul className="mt-10 space-y-4">
                        <li className={`flex items-center gap-3 px-4 py-2 rounded-xl cursor-pointer ${sidebarHover}`}>
            ...
            {/* Right Sidebar */}
            <aside className={`w-80 ${sidebarBg} p-6 space-y-6 rounded-l-2xl shadow-lg ${sidebarText}`}>
                {/* Profile */}
