...
export default function RecentActivityCard({ activities = [] }) {
  ...
  return (
    <div className="h-[260px] rounded-[32px] bg-gradient-to-br from-[#9d8adb] to-[#4c4172] px-8 py-7 text-white shadow-[0_26px_60px_rgba(76,65,114,0.45)] overflow-hidden">
